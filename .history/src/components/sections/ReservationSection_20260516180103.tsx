        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <User
                  size={14}
                  className="absolute left-4 top-1/2 -translate-y-1/2 text-white/30 z-10 pointer-events-none"
                />
                <input
                  type="text"
                  name="name"
              ...
              <button
                onClick={() =>
                  window.open(
                    "https://api.whatsapp.com/send?phone=" + GROUP_WA + "&text=" + GROUP_MSG,
                    "_blank"
                  )
                }
          ...
          >
            ...
            <div className="space-y-3">
                ...
                href={"https://api.whatsapp.com/send?phone=" + GROUP_WA + "&text=" + GROUP_MSG}
                target="_blank"
                rel="noopener noreferrer"
              ...
              >
                ...
                href={"https://api.whatsapp.com/send?phone=" + GROUP_WA + "&text=" + BUSINESS_MSG}
                target="_blank"
                rel="noopener noreferrer"
            ...
            <div className="bg-kaizen-black/60 border border-white/5 p-5 rounded-sm">
              <p className="text-kaizen-gold text-xs tracking-widest uppercase font-semibold mb-3">
                Info Reservasi
              </p>
              <ul className="space-y-2 text-white/50 text-sm">
                <li className="flex gap-2">
                  <span className="text-kaizen-red">—</span>
                  Pilih cabang, WA otomatis tersambung
                </li>
                <li className="flex gap-2">
                  <span className="text-kaizen-red">—</span>
                ...
                <li className="flex gap-2">
                  <span className="text-kaizen-red">—</span>
                  Grup besar (30+ pax) hubungi khusus
                </li>
              </ul>
            </div>
          </motion.div>
